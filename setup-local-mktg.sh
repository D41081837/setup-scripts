...
echo $SAVEDACQUIATOKEN >> ~/setup-scripts/.setup_vars
SAVEDACQUIASECRET='MYACQUIASECRET="'$MYACQUIASECRET'"'
echo $SAVEDACQUIASECRET >> ~/setup-scripts/.setup_vars
...
cp ~/setup-scripts/.setup_vars ~/vms/CMS-Drupal-MKTG/vendor/acquia/blt/scripts/blt/setup_vars
